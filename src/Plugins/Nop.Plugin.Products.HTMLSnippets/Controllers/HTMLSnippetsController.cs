...
namespace Nop.Plugin.Product.HTMLSnippets.Controllers
{
    ...
    public class HTMLSnippetsController : BasePluginController
    {
        ...
        public async Task<IActionResult> Configure()
        {
            ...
            return View("~/Plugins/Products.HTMLSnippets/Views/Configuraton/Configure.cshtml", model);
        ...
        public IActionResult AddSnippet(int index)
        {
            ...
            return PartialView("~/Plugins/Products.HTMLSnippets/Views/Configuraton/AddSnippet.cshtml", snippet);
        }
    }
}
