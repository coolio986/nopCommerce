...
namespace Nop.Services.Orders
{
    ...
    public partial class DraftOrderService : IDraftOrderService
    {
        ...
        {
            return await _draftOrderRepository.GetByIdAsync(orderId, cache => default, useShortTermCache: true);
        }
        ...
        {
            return await _draftOrderItemRepository.GetByIdAsync(orderItemId, cache => default, useShortTermCache: true);
        }
