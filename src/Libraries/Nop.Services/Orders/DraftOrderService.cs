...
namespace Nop.Services.Orders
{
    ...
    /// Order service
    /// </summary>
    public partial class DraftOrderService : IDraftOrderService
    {
        #region Fields
        ...
        private readonly IRepository<DraftOrder> _draftOrderRepository;
        private readonly IRepository<DraftOrderItem> _draftOrderItemRepository;
        private readonly IRepository<DraftOrderNote> _draftOrderNoteRepository;
        ...
        public DraftOrderService(IHtmlFormatter htmlFormatter,
            IProductService productService,
            IRepository<Address> addressRepository,
            IRepository<Customer> customerRepository,
            IRepository<DraftOrder> draftOrderRepository,
            IRepository<DraftOrderItem> draftOrderItemRepository,
            IRepository<DraftOrderNote> draftOrderNoteRepository,
            ...
            IShipmentService shipmentService)
        {
            ...
            _draftOrderItemRepository = draftOrderItemRepository;
            _draftOrderNoteRepository = draftOrderNoteRepository;
        ...
        /// </returns>
        public virtual async Task<DraftOrder> GetOrderByIdAsync(int orderId)
        {
            return await _draftOrderRepository.GetByIdAsync(orderId,
                cache => cache.PrepareKeyForShortTermCache(NopEntityCacheDefaults<DraftOrder>.ByIdCacheKey, orderId));
        }
        ...
        /// The task result contains the order
        /// </returns>
        public virtual async Task<DraftOrder> GetOrderByCustomOrderNumberAsync(string customOrderNumber)
        {
            if (string.IsNullOrEmpty(customOrderNumber))
                return null;

            return await _draftOrderRepository.Table
        ...
        /// The task result contains the order
        /// </returns>
        public virtual async Task<DraftOrder> GetOrderByOrderItemAsync(int orderItemId)
        {
            if (orderItemId == 0)
                return null;

            return await (from o in _draftOrderRepository.Table
                    join oi in _draftOrderItemRepository.Table on o.Id equals oi.OrderId
        ...
        /// The task result contains the order
        /// </returns>
        public virtual async Task<IList<DraftOrder>> GetOrdersByIdsAsync(int[] orderIds) 
        {
            return await _draftOrderRepository.GetByIdsAsync(orderIds, includeDeleted: false);
        }
        ...
        /// The task result contains the order
        /// </returns>
        public virtual async Task<DraftOrder> GetOrderByGuidAsync(Guid orderGuid)
        {
            if (orderGuid == Guid.Empty)
                return null;

            var query = from o in _draftOrderRepository.Table
        ...
        public virtual async Task DeleteOrderAsync(DraftOrder order)
        {
            await _draftOrderRepository.DeleteAsync(order);
        }
        ...
        /// </returns>
        public virtual async Task<IPagedList<DraftOrder>> SearchDraftOrdersAsync(int storeId = 0,
        ...
        {
            var query = _draftOrderRepository.Table;
            ...
            if (!string.IsNullOrEmpty(orderNotes))
                query = query.Where(o => _draftOrderNoteRepository.Table.Any(oNote => oNote.OrderId == o.Id && oNote.Note.Contains(orderNotes)));
            ...
            query = query.Where(o => o.BillingAddressId >= 0);
        ...
        /// <param name="order">Order</param>
        /// <returns>A task that represents the asynchronous operation</returns>
        public virtual async Task InsertOrderAsync(DraftOrder order)
        {
            await _draftOrderRepository.InsertAsync(order);
        }
        ...
        /// <param name="order">The order</param>
        /// <returns>A task that represents the asynchronous operation</returns>
        public virtual async Task UpdateOrderAsync(DraftOrder order)
        {
            await _draftOrderRepository.UpdateAsync(order);
        }
        ...
        /// </returns>
        public virtual async Task<bool> HasItemsToAddToShipmentAsync(DraftOrder order)
        {
            if (order == null)
        ...
        /// </returns>
        public virtual async Task<DraftOrderItem> GetOrderItemByIdAsync(int orderItemId)
        {
            return await _draftOrderItemRepository.GetByIdAsync(orderItemId,
                cache => cache.PrepareKeyForShortTermCache(NopEntityCacheDefaults<DraftOrderItem>.ByIdCacheKey, orderItemId));
        }
        ...
        public virtual async Task<Product> GetProductByOrderItemIdAsync(int orderItemId)
        {
            ...
            return await (from p in _productRepository.Table
                    join oi in _draftOrderItemRepository.Table on p.Id equals oi.ProductId
                    where oi.Id == orderItemId
        ...
        /// </returns>
        public virtual async Task<IList<DraftOrderItem>> GetOrderItemsAsync(int orderId, bool? isNotReturnable = null, bool? isShipEnabled = null, int vendorId = 0)
        {
            if (orderId == 0)
                return new List<DraftOrderItem>();

            return await (from oi in _draftOrderItemRepository.Table
                    join p in _productRepository.Table on oi.ProductId equals p.Id
                    where
                    oi.OrderId == orderId &&
        ...
        /// The task result contains the order item
        /// </returns>
        public virtual async Task<DraftOrderItem> GetOrderItemByGuidAsync(Guid orderItemGuid)
        {
            if (orderItemGuid == Guid.Empty)
                return null;

            var query = from orderItem in _draftOrderItemRepository.Table
        ...
        /// </returns>
        public virtual async Task<IList<DraftOrderItem>> GetDownloadableOrderItemsAsync(int customerId)
        {
            if (customerId == 0)
                throw new ArgumentOutOfRangeException(nameof(customerId));

            var query = from orderItem in _draftOrderItemRepository.Table
                        join o in _draftOrderRepository.Table on orderItem.OrderId equals o.Id
        ...
        /// <returns>A task that represents the asynchronous operation</returns>
        public virtual async Task DeleteOrderItemAsync(DraftOrderItem orderItem)
        {
            await _draftOrderItemRepository.DeleteAsync(orderItem);
        }
        ...
        /// </returns>
        public virtual async Task<int> GetTotalNumberOfItemsInAllShipmentsAsync(DraftOrderItem orderItem)
        {
            if (orderItem == null)
        ...
        /// </returns>
        public virtual async Task<int> GetTotalNumberOfItemsCanBeAddedToShipmentAsync(DraftOrderItem orderItem)
        {
            if (orderItem == null)
                throw new ArgumentNullException(nameof(orderItem));
        ...
        /// </returns>
        public virtual async Task<bool> IsDownloadAllowedAsync(DraftOrderItem orderItem)
        {
        ...
        /// </returns>
        public virtual async Task<bool> IsLicenseDownloadAllowedAsync(DraftOrderItem orderItem)
        {
            if (orderItem == null)
                return false;
        ...
        /// <param name="orderItem">Order item</param>
        /// <returns>A task that represents the asynchronous operation</returns>
        public virtual async Task InsertOrderItemAsync(DraftOrderItem orderItem)
        {
            await _draftOrderItemRepository.InsertAsync(orderItem);
        }
        ...
        /// <param name="orderItem">Order item</param>
        /// <returns>A task that represents the asynchronous operation</returns>
        public virtual async Task UpdateOrderItemAsync(DraftOrderItem orderItem)
        {
            await _draftOrderItemRepository.UpdateAsync(orderItem);
        }
        ...
        /// </returns>
        public virtual async Task<DraftOrderNote> GetOrderNoteByIdAsync(int orderNoteId)
        {
            return await _draftOrderNoteRepository.GetByIdAsync(orderNoteId);
        }
        ...
        /// The task result contains the result
        /// </returns>
        public virtual async Task<IList<DraftOrderNote>> GetOrderNotesByOrderIdAsync(int orderId, bool? displayToCustomer = null)
        {
            if (orderId == 0)
                return new List<DraftOrderNote>();

            var query = _draftOrderNoteRepository.Table.Where(on => on.OrderId == orderId);
        ...
        /// <returns>A task that represents the asynchronous operation</returns>
        public virtual async Task DeleteOrderNoteAsync(DraftOrderNote orderNote)
        {
            await _draftOrderNoteRepository.DeleteAsync(orderNote);
        }
        ...
        public virtual string FormatOrderNoteText(DraftOrderNote orderNote)
        {
            if (orderNote == null)
        ...
        /// <param name="orderNote">The order note</param>
        /// <returns>A task that represents the asynchronous operation</returns>
        public virtual async Task InsertOrderNoteAsync(DraftOrderNote orderNote)
        {
            await _draftOrderNoteRepository.InsertAsync(orderNote);
        }
            ...
            int pageIndex = 0, int pageSize = int.MaxValue, bool showHidden = false)
        {
            ...
            var query1 = from rp in _recurringPaymentRepository.Table
                         join o in _draftOrderRepository.Table on rp.InitialOrderId equals o.Id
