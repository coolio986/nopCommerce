...
namespace Nop.Services.Orders
{
    ...
    /// </summary>
    public partial interface IDraftOrderService
    {
        #region Orders
        ...
        /// </returns>
        Task<DraftOrder> GetOrderByIdAsync(int orderId);
        ...
        /// The task result contains the order
        /// </returns>
        Task<DraftOrder> GetOrderByCustomOrderNumberAsync(string customOrderNumber);
        ...
        /// The task result contains the order
        /// </returns>
        Task<DraftOrder> GetOrderByOrderItemAsync(int orderItemId);
        ...
        /// The task result contains the order
        /// </returns>
        Task<IList<DraftOrder>> GetOrdersByIdsAsync(int[] orderIds);
        ...
        /// The task result contains the order
        /// </returns>
        Task<DraftOrder> GetOrderByGuidAsync(Guid orderGuid);
        ...
        Task DeleteOrderAsync(DraftOrder order);
        ...
        /// </returns>
        Task<IPagedList<DraftOrder>> SearchDraftOrdersAsync(int storeId = 0,
        ...
        /// <returns>A task that represents the asynchronous operation</returns>
        Task InsertOrderAsync(DraftOrder order);
        ...
        /// <param name="order">The order</param>
        /// <returns>A task that represents the asynchronous operation</returns>
        Task UpdateOrderAsync(DraftOrder order);
        ...
        /// </returns>
        Task<DraftOrderItem> GetOrderItemByIdAsync(int orderItemId);
        ...
        /// </returns>
        Task<IList<DraftOrderItem>> GetOrderItemsAsync(int orderId, bool? isNotReturnable = null, bool? isShipEnabled = null, int vendorId = 0);
        ...
        /// The task result contains the order item
        /// </returns>
        Task<DraftOrderItem> GetOrderItemByGuidAsync(Guid orderItemGuid);
        ...
        /// </returns>
        Task<IList<DraftOrderItem>> GetDownloadableOrderItemsAsync(int customerId);
        ...
        /// <returns>A task that represents the asynchronous operation</returns>
        Task DeleteOrderItemAsync(DraftOrderItem orderItem);
        ...
        /// </returns>
        Task<int> GetTotalNumberOfItemsInAllShipmentsAsync(DraftOrderItem orderItem);
        ...
        /// </returns>
        Task<int> GetTotalNumberOfItemsCanBeAddedToShipmentAsync(DraftOrderItem orderItem);
        ...
        /// </returns>
        Task<bool> IsDownloadAllowedAsync(DraftOrderItem orderItem);
        ...
        /// </returns>
        Task<bool> IsLicenseDownloadAllowedAsync(DraftOrderItem orderItem);
        ...
        /// <param name="orderItem">Order item</param>
        /// <returns>A task that represents the asynchronous operation</returns>
        Task InsertOrderItemAsync(DraftOrderItem orderItem);
        ...
        /// <param name="orderItem">Order item</param>
        /// <returns>A task that represents the asynchronous operation</returns>
        Task UpdateOrderItemAsync(DraftOrderItem orderItem);
        ...
        /// </returns>
        Task<DraftOrderNote> GetOrderNoteByIdAsync(int orderNoteId);
        ...
        /// The task result contains the result
        /// </returns>
        Task<IList<DraftOrderNote>> GetOrderNotesByOrderIdAsync(int orderId, bool? displayToCustomer = null);
        ...
        /// <returns>A task that represents the asynchronous operation</returns>
        Task DeleteOrderNoteAsync(DraftOrderNote orderNote);
        ...
        string FormatOrderNoteText(DraftOrderNote orderNote);
        ...
        /// <param name="orderNote">The order note</param>
        /// <returns>A task that represents the asynchronous operation</returns>
        Task InsertOrderNoteAsync(DraftOrderNote orderNote);
